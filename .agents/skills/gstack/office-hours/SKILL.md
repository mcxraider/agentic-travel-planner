...
On any error, proceed to Phase 4 — do NOT fall back to a Codex subagent (this is brainstorming, not adversarial review).
...
5. **Cross-model synthesis:** After presenting Codex output, provide 3-5 bullet synthesis:
   - Where Codex agrees with Codex
   - Where Codex disagrees and why
   - Whether Codex's challenged premise changes Codex's recommendation
